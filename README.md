<div align="center">
  <img src="./screenshots/logo.png" alt="SketchDuel Logo" width="200" />
...
| ![Landing Page](./screenshots/landing.png) | ![Match Setup Screen](./screenshots/match-setup.png) |
|:---:|:---:|
| *Landing Page* | *Match Setup Screen* |

| ![Word Reveal](./screenshots/word-reveal.png) | ![Draw Countdown](./screenshots/draw-countdown.png) |
|:---:|:---:|
| *Word Reveal* | *Draw Countdown* |

| ![Live Gameplay](./screenshots/gameplay.png) | ![Correct Guess Celebration](./screenshots/correct-guess.png) |
|:---:|:---:|
| *Live Gameplay* | *Correct Guess Celebration* |

| ![Signal Terminated](./screenshots/signal-terminated.png) | ![SketchDuel Logo](./screenshots/logo.png) |
|:---:|:---:|
| *Signal Terminated (Error State)* | *SketchDuel Logo* |
...
- **🛡️ Defensive parsing:** Strict JSON schema via `responseMimeType`, markdown fences stripped, one strict retry on malformed output, confidence clamped.
